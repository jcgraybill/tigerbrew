class Erlang25 < Formula
  ...
  stable do
    url "https://github.com/erlang/otp/archive/OTP-25.3.2.20.tar.gz"
    sha256 "513bd9d2fc9c792984314feead5d971bb19e6ee531b4e208d4d4fd30774523f6"
end

  resource "man" do
    url "http://www.erlang.org/download/otp_doc_man_25.3.tar.gz"
    sha256 "675658e5cac834ffe726e180d3f7839e23d32fa57ae921a524ac9f808b6ed76e"
end

  resource "html" do
    url "http://www.erlang.org/download/otp_doc_html_25.3.tar.gz"
